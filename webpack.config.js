...
const BundleAnalyzerPlugin = require('webpack-bundle-analyzer').BundleAnalyzerPlugin; // 文件体积分析  需要 yarn add webpack-bundle-analyzer -D
...
const getEntry = () => {
    const entry = {};
    Object.keys(entryObj).forEach((v) => (entry[v] = `./src/pages/${v}/index.js`));
    return entry;
};
